  ...
  <div :class="themeClasses.pageBackground">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
          <div class="flex items-center">
            <h1 :class="`text-xl font-bold ${themeClasses.navText}`">
              Assessment Platform
            </h1>
          </div>
          <div class="flex items-center space-x-4">
            ...
            <NuxtLink
              v-if="!user"
              :to="$localePath('/login')"
              :class="`${themeClasses.navTextSecondary} ${themeClasses.navTextHover} transition-colors`"
            >
              {{ $t("home.login") }}
            </NuxtLink>
            <NuxtLink
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="text-center mb-16">
        ...
        <p
          :class="`text-xl ${themeClasses.textSecondary} mb-8 max-w-3xl mx-auto`"
        >
          Explore your personality, values, and skills with our
      ...
      <div class="mb-12">
        <h3
          :class="`text-2xl font-bold ${themeClasses.textPrimary} mb-6 flex items-center`"
        >
          🔥 Most Popular
        </h3>
        <div class="grid lg:grid-cols-6 md:grid-cols-3 sm:grid-cols-2 gap-6">
          ...
          >
            <NuxtLink :to="$localePath(`/test/${test.id}`)">
              <div
                :class="`relative rounded-lg overflow-hidden ${themeClasses.cardShadow} ${themeClasses.testCardBackground} group`"
              >
                <!-- Cover Image -->
                <div class="aspect-[3/4] relative overflow-hidden">
                  ...
                  />
                  <div
                    class="absolute inset-0 bg-gradient-to-t from-black via-transparent to-black bg-opacity-60"
                  ></div>

                  <!-- Category Tag -->
                  <div class="absolute top-2 left-2">
                    <span
                      class="bg-black bg-opacity-70 text-white px-2 py-1 rounded-full text-xs font-medium backdrop-blur-sm"
                    >
                ...
                <div :class="`p-3 ${themeClasses.testCardFooter}`">
                  <h4
                    :class="`${themeClasses.textPrimary} font-bold text-sm mb-1 truncate`"
                  >
                    {{ test.name }}
                  </h4>
                  <p
                    :class="`${themeClasses.textSecondary} text-xs mb-2 line-clamp-2`"
                  >
                    {{ test.short_description }}
                  </p>
                  <div
                    :class="`flex items-center justify-between text-xs ${themeClasses.textMuted}`"
                  >
      ...
      <div v-for="category in getCategories()" :key="category" class="mb-12">
        <h3
          :class="`text-2xl font-bold ${themeClasses.textPrimary} mb-6 flex items-center`"
        >
      ...
      <div :class="`${themeClasses.featureBackground} rounded-xl p-8 mb-12`">
        <h3
          :class="`text-2xl font-bold ${themeClasses.textPrimary} mb-6 text-center`"
        >
        ...
        <div class="grid md:grid-cols-3 gap-8">
          <div class="text-center">
            ...
            <h4
              :class="`text-lg font-semibold mb-2 ${themeClasses.textPrimary}`"
            >
              Science-Based
            </h4>
            <p :class="themeClasses.textSecondary">
              All assessments based on validated psychological research and
          ...
          <div class="text-center">
            ...
            <p :class="themeClasses.textSecondary">
              Get comprehensive reports with personalized recommendations for
              growth
            </p>
          </div>
          <div class="text-center">
            ...
            <p :class="themeClasses.textSecondary">
              Monitor your development over time with our progress tracking
              system
            </p>
          </div>
        </div>
...
const tests = ref([
  // === EXISTING TESTS (keeping for compatibility) ===
  {
    ...
    short_description:
      "Discover your moral reasoning stage through ethical dilemmas",
    description:
      "Assess your stage of moral reasoning based on Lawrence Kohlberg's theory of moral development",
  ...
  },
  {
    ...
    description:
      "Comprehensive personality assessment based on the five-factor model (OCEAN)",
    category: "values_mindsets",
    subcategory: "other_values",
  ...
  },
  {
    ...
    description:
      "Evaluate your communication effectiveness across different contexts and situations",
  ...
  },
  {
    ...
    description:
      "Assess your project management skills and leadership capabilities",
    category: "knowledge",
  ...
  // === NEW MOTIVATION TESTS ===
  {
    ...
    short_description:
      "Discover what truly drives you: fears, passions, and core motivations",
    description:
      "Deep dive into your fundamental motivational drivers, including fear-based and passion-driven behaviors",
    category: "motivation",
  ...
  },
  {
    ...
    short_description:
      "Evaluate your current challenges and readiness for transformation",
    description:
      "Assess your current life situation, challenges, and readiness to implement meaningful changes",
    category: "motivation",
  ...
  // === NEW KNOWLEDGE TESTS ===
  {
    ...
    short_description:
      "Measure your effectiveness in leading and managing teams",
    description:
      "Comprehensive evaluation of your team leadership skills, including motivation, delegation, and team dynamics",
    category: "knowledge",
    subcategory: "managerial",
  ...
  },
  {
    ...
    short_description:
      "Assess your ability to drive and manage organizational change",
    description:
      "Evaluate your skills in leading organizational transformation, overcoming resistance, and implementing change",
    category: "knowledge",
    subcategory: "managerial",
  ...
  // === NEW SKILLS/STRENGTHS TESTS ===
  {
    ...
    description:
      "Discover your unique combination of talents and strengths, similar to StrengthsFinder methodology",
    category: "skills_strengths",
  ...
  },
  {
    ...
    short_description:
      "Evaluate your analytical and logical reasoning abilities",
    description:
      "Assess your critical thinking skills including analysis, evaluation, inference, and problem-solving",
    category: "skills_strengths",
    subcategory: "4cs",
  ...
  },
  {
    ...
    short_description:
      "Measure your creative thinking and innovation potential",
    description:
      "Evaluate your creative problem-solving abilities, divergent thinking, and innovation mindset",
    category: "skills_strengths",
    subcategory: "4cs",
  ...
  },
  {
    ...
    short_description:
      "Assess your teamwork and collaborative leadership skills",
    description:
      "Evaluate your ability to work effectively with others, facilitate cooperation, and build consensus",
    category: "skills_strengths",
    subcategory: "4cs",
  ...
  // === NEW VALUES & MINDSETS TESTS ===
  {
    ...
    short_description:
      "Evaluate your character strength, moral courage, and integrity",
    description:
      "Assess your character development including respect, moral courage, and ethical decision-making",
    category: "values_mindsets",
  ...
  },
  {
    ...
    short_description:
      "Measure your drive for excellence and continuous improvement",
    description:
      "Assess your commitment to excellence, quality standards, and continuous improvement mindset",
    category: "values_mindsets",
    subcategory: "4es_chela",
  ...
  },
  {
    ...
    short_description:
      "Assess your entrepreneurial thinking and opportunity recognition",
    description:
      "Evaluate your entrepreneurial mindset including opportunity identification, risk-taking, and bias for action",
    category: "values_mindsets",
    subcategory: "4es_chela",
  ...
  },
  {
    ...
    short_description:
      "Measure your level of engagement and commitment to causes",
    description:
      "Assess your dedication, commitment level, and engagement with work and causes you care about",
    category: "values_mindsets",
    subcategory: "4es_chela",
  ...
  },
  {
    ...
    description:
      "Comprehensive assessment of 24 character strengths that represent your core values in action",
    category: "values_mindsets",
    subcategory: "other_values",
  ...
  // === MOVED TO VALUES & MINDSETS ===
  {
    ...
    short_description:
      "Identify your preferred organizational culture and development stage",
    description:
      "Assess your preferences across organizational culture types from Red to Teal (Spiral Dynamics)",
    category: "values_mindsets",
    subcategory: "other_values",
  ...
  },
  {
    ...
    short_description:
      "Understand your stage of adult psychological development",
    description:
      "Assessment based on Robert Kegan's stages of adult development and meaning-making",
    category: "values_mindsets",
    subcategory: "other_values",
  ...
  },
  {
    ...
    description:
      "Assessment to help identify and understand your implicit biases across various dimensions",
    category: "values_mindsets",
    subcategory: "other_values",
...
const getRecommendedTests = () => {
  const completedTests = new Set(
    userTestResults.value.map((r) => r.test_type_id)
  );
...
const getTestImage = (testId) => {
  const images = {
    // Existing
    kohlberg_moral:
      "https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=400&h=600&fit=crop&crop=center",
    big_five_personality:
      "https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=400&h=600&fit=crop&crop=center",
    communication_skills:
      "https://images.unsplash.com/photo-1573164713714-d95e436ab8d6?w=400&h=600&fit=crop&crop=center",
    project_management:
      "https://images.unsplash.com/photo-1552664730-d307ca884978?w=400&h=600&fit=crop&crop=center",

    // Motivation
    personal_motivation:
      "https://images.unsplash.com/photo-1434626881859-194d67b2b86f?w=400&h=600&fit=crop&crop=center",
    change_readiness:
      "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?w=400&h=600&fit=crop&crop=center",
    ...
    collaboration_skills:
      "https://images.unsplash.com/photo-1556761175-b413da4baf72?w=400&h=600&fit=crop&crop=center",

    // Values & Mindsets
    character_assessment:
      "https://images.unsplash.com/photo-1521790361543-f645cf042ec4?w=400&h=600&fit=crop&crop=center",
    excellence_mindset:
      "https://images.unsplash.com/photo-1496449903678-68ddcb189a24?w=400&h=600&fit=crop&crop=center",
    entrepreneurship:
      "https://images.unsplash.com/photo-1553028826-f4804a6dfd3f?w=400&h=600&fit=crop&crop=center",
    engagement_commitment:
      "https://images.unsplash.com/photo-1559136555-9303baea8ebd?w=400&h=600&fit=crop&crop=center",
    via_values:
      "https://images.unsplash.com/photo-1582213782179-e0d53f98f2ca?w=400&h=600&fit=crop&crop=center",
    org_culture_preference:
      "https://images.unsplash.com/photo-1497366216548-37526070297c?w=400&h=600&fit=crop&crop=center",
    kegan_stages:
      "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=400&h=600&fit=crop&crop=center",
    implicit_bias:
      "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&h=600&fit=crop&crop=center",
  };
  return (
    images[testId] ||
    "https://images.unsplash.com/photo-1432888498266-38ffec3eaf0a?w=400&h=600&fit=crop&crop=center"
  );
};
...
const getCategories = () => {
  const uniqueCategories = [
    ...new Set(tests.value.map((test) => test.category)),
  ];
  ...
  meta: [
    {
      name: "description",
      content:
        "Explore your personality, values, and skills with our scientifically-backed assessment suite. Get personalized insights and track your growth over time.",
    },
  ],
});
</script>
